    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-background via-background to-primary/5">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Card className="shadow-xl border-0 bg-card/95 backdrop-blur-sm">
            <CardHeader className="text-center space-y-4 pb-6">
              <CardTitle className="text-xl font-bold text-primary">Parent Registration</CardTitle>
              <CardDescription className="text-muted-foreground">Register after your child has been enrolled by the school</CardDescription>
            </CardHeader>
            <CardContent>
